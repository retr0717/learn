...
const QCard = ({ mcq }) => {
    ...
    return (
        <div>
            <div class="w-full mb-4 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
...
export default connect(mapStateToProps, null)(SVideoComponent);